...
import ShrifBchcha2 from "../assets/shipra.jpg";
    ...
    <div className=" flex m-3  flex-col  items-center  justify-center mt-[170px] md:flex-row-reverse md:px-[200px]  md:justify-between   ">
      ...
      <div className=" flex flex-col justify-center  text-white mt-2  md:justify-start ">
        ...
        <div className="flex flex-col py-3  text-[#808DAD] ">
          <h1 className="text-center md:text-start font-bold text-xl text-green-200">Full Stack Developer</h1>
          <p className="py-5  text-center md:text-start">
            Hi there! My name is Shipra Suman and I'm a dedicated MERN stack developer actively seeking new opportunities to contribute expertise in MongoDB, Express.js, React, and Node.js. Eager to apply skills and passion for creating impactful web solutions in a dynamic work environment.
          </p>
        </div>

        <div className="flex justify-center mt-[30px] md:justify-start ">
          <a href={Resume} target="_blank" download="ShipraResume.pdf"><button className="btn btn-gradient-border btn-glow flex justify-center items-center ">
            Resume
          </button>
          </a>
        </div>
