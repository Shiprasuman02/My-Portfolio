...
const scrollToSection = (elementRef) => {
  ...
  return (
    <div className=" flex top-0 bg-[#0E1630] justify-between items-center md:px-[200px] px-4 h-[80px] fixed w-full z-50">
      {/* Logo */}
      <div>
        <h1 className="text-white text-[25px] md:text-[30px] font-quickstand font-quickstandCustom w-3">
          <span className="text-[#4ade80]">S</span>hipra{" "}
          <span className="text-[#4ade80]">S</span>uman
        </h1>
      </div>
